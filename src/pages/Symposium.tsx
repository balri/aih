  ...
  return (
    <section>
      <div className="wrap">
        ...
        <p>The symposium brings together professionals from government, academia and industry.</p>
        <h3>Session Topics</h3>
        <ul>
          {topics.map((t) => <li key={t}>{t}</li>)}
        </ul>
        <p>The conference concludes with a commemorative group photograph featuring delegates and presenters.</p>
      </div>
    </section>
  );
}
